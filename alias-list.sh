...
alias push-subl='~/Library/Application\ Support/Sublime\ Text\ 3 && git add -A && git commit -am "Perodic Automatic Backup." && git push --all'
...
alias cp='cp -ivpR'
alias brew-update='brew update && brew upgrade && brew cleanup --prune=0'
alias software-update='softwareupdate -ia'
