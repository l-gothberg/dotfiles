...
brew "bitcoin"                 # Bitcoin Core
brew "handbrake"               # video transcoding software
brew "monero"                  # Monero Wallet & Miner
...
# ─── Communication & media ───────────────────────────────────────────────────
# cask "chirp"                   # ham radio programming software -- disabled due to Cloudflare isses on 2025-08-05
